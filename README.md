...
# 📊 Dashboard de RH Insights & 🤖 Assistente de IA
### Personal Analytics Case
...
<p align="center">
  <b>Business Intelligence + IA Generativa (RAG) para diagnósticos de RH</b>
</p>
...
> [!WARNING]
> **Paradoxo da Satisfação**
> No **Ano 2**, o desempenho é alto, mas a satisfação cai drasticamente (Risco de burnout ou falta de reconhecimento).
...
1.  **👮 Auditoria de Gestão:** Identificamos que a gestão de **Rafael Costa (Marketing)** necessita de intervenção, pois gerencia o maior orçamento da empresa com o menor retorno em desempenho.
2.  **🏆 Benchmarking Interno:** A IA sugere replicar as práticas de **Tiago Ramos (Tecnologia)**, que mantém a maior equipe com o menor custo total e a maior nota de avaliação.
3.  **🩸 Retenção de Talentos:** O problema de turnover não é "limpeza de base". A empresa está perdendo **Analistas Plenos com nota 7.54** (acima da média). É uma sangria de talentos.
